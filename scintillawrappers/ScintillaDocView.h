...
//Printing support
  ...
  virtual void PrintHeader(CDC* pDC, CPrintInfo* pInfo, Sci_RangeToFormatFull& frPrint);
  virtual void PrintFooter(CDC* pDC, CPrintInfo* pInfo, Sci_RangeToFormatFull& frPrint);
...
//Search and Replace support
  ...
  virtual Sci_Position FindAndSelect(_In_ DWORD dwFlags, _Inout_ Sci_TextToFindFull& ft);
